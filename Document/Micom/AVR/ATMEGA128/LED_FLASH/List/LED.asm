...
; 0000 0043 // State7=1 State6=1 State5=1 State4=1 State3=1 State2=1 State1=1 State0=1
; 0000 0044 PORTF=0xFF;
	LDI  R30,LOW(255)
	STS  98,R30
; 0000 0045 DDRF=0xFF;
	STS  97,R30
...
; 0000 0048 // Func4=In Func3=In Func2=In Func1=In Func0=In
; 0000 0049 // State4=T State3=T State2=T State1=T State0=T
; 0000 004A PORTG=0x00;
	LDI  R30,LOW(0)
	STS  101,R30
; 0000 004B DDRG=0x00;
	STS  100,R30
...
; 0000 007D // Clock value: Timer 3 Stopped
; 0000 007E // Mode: Normal top=FFFFh
; 0000 007F // Noise Canceler: Off
; 0000 0080 // Input Capture on Falling Edge
; 0000 0081 // OC3A output: Discon.
; 0000 0082 // OC3B output: Discon.
; 0000 0083 // OC3C output: Discon.
; 0000 0084 // Timer 3 Overflow Interrupt: Off
...
; 0000 0089 TCCR3A=0x00;
	STS  139,R30
; 0000 008A TCCR3B=0x00;
	STS  138,R30
...
; 0000 009D // INT6: Off
; 0000 009E // INT7: Off
; 0000 009F EICRA=0x00;
	STS  106,R30
; 0000 00A0 EICRB=0x00;
	OUT  0x3A,R30
; 0000 00A1 EIMSK=0x00;
	OUT  0x39,R30
; 0000 00A2 
...
_0x3:
; 0000 00B1       {
; 0000 00B2         PORTF = 0x00;
	LDI  R30,LOW(0)
	CALL SUBOPT_0x0
; 0000 00B3         delay_ms(1000);
; 0000 00B4         PORTF = 0XFF;
	LDI  R30,LOW(255)
	CALL SUBOPT_0x0
