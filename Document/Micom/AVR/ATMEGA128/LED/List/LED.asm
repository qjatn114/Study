...
; 0000 002C DDRD=0x00;
	OUT  0x11,R30
; 0000 002D 
; 0000 002E // Port E initialization
...
; 0000 0032 DDRE=0x00;
	OUT  0x2,R30
; 0000 0033 
; 0000 0034 // Port F initialization
; 0000 0035 // Func7=Out Func6=Out Func5=Out Func4=Out Func3=Out Func2=Out Func1=Out Func0=Out
; 0000 0036 // State7=1 State6=1 State5=1 State4=1 State3=1 State2=1 State1=1 State0=1
; 0000 0037 PORTF=0xFF;
	LDI  R30,LOW(255)
	STS  98,R30
; 0000 0038 DDRF=0xFF;
	STS  97,R30
; 0000 0039 
; 0000 003A // Port G initialization
; 0000 003B // Func4=In Func3=In Func2=In Func1=In Func0=In
; 0000 003C // State4=T State3=T State2=T State1=T State0=T
; 0000 003D PORTG=0x00;
	LDI  R30,LOW(0)
	STS  101,R30
; 0000 003E DDRG=0x00;
	STS  100,R30
...
; 0000 0057 // Compare C Match Interrupt: Off
...
; 0000 0061 OCR1BL=0x00;
	OUT  0x28,R30
; 0000 0062 OCR1CH=0x00;
	STS  121,R30
; 0000 0063 OCR1CL=0x00;
	STS  120,R30
; 0000 0064 
...
; 0000 006C OCR2=0x00;
	OUT  0x23,R30
; 0000 006D 
; 0000 006E // Timer/Counter 3 initialization
; 0000 006F // Clock source: System Clock
; 0000 0070 // Clock value: Timer 3 Stopped
; 0000 0071 // Mode: Normal top=FFFFh
...
; 0000 0076 // OC3C output: Discon.
; 0000 0077 // Timer 3 Overflow Interrupt: Off
...
; 0000 0085 OCR3BL=0x00;
	STS  132,R30
; 0000 0086 OCR3CH=0x00;
	STS  131,R30
; 0000 0087 OCR3CL=0x00;
	STS  130,R30
; 0000 0088 
...
; 0000 0090 // INT6: Off
; 0000 0091 // INT7: Off
; 0000 0092 EICRA=0x00;
	STS  106,R30
; 0000 0093 EICRB=0x00;
	OUT  0x3A,R30
; 0000 0094 EIMSK=0x00;
	OUT  0x39,R30
; 0000 0095 
; 0000 0096 // Timer(s)/Counter(s) Interrupt(s) initialization
; 0000 0097 TIMSK=0x00;
	OUT  0x37,R30
; 0000 0098 ETIMSK=0x00;
	STS  125,R30
; 0000 0099 
...
; 0000 009E SFIOR=0x00;
	...
	OUT  0x20,R30
; 0000 009F 
; 0000 00A0 DDRF = 0xFF;     //OUTPUT MODE
	LDI  R30,LOW(255)
	STS  97,R30
; 0000 00A1 PORTF = 0xFF;    //PULL UP ON
	STS  98,R30
; 0000 00A2 
; 0000 00A3 while (1)
_0x3:
; 0000 00A4       {
; 0000 00A5         LED_ALL_OFF;
	LDI  R30,LOW(15)
	CALL SUBOPT_0x0
; 0000 00A6         delay_ms(1000);
; 0000 00A7         LED_ALL_ON;
	LDI  R30,LOW(136)
	CALL SUBOPT_0x0
