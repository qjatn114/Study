...
/* Interrupt Mode */
//	mcp25625_setRegister(fd,MCP_CANINTE,MCP_RX0IF);
//	mcp25625_modifyRegister(fd, MCP_CANINTE, MCP_TX_INT, 0);
/* Turn Mask/Filter OFF */
...
/*  Set RTS */
//	mcp25625_setRegister(fd,MCP_TXRTSCTRL,0);
//	mcp25625_modifyRegister(fd,MCP_TXRTSCTRL, 0x01, 1);
...
/* Set Filter Extended Enable bit  */
	mcp25625_modifyRegister(fd,MCP_RXF0SIDL,0x08,1);
	mcp25625_modifyRegister(fd,MCP_RXF1SIDL,0x08,1);
	mcp25625_modifyRegister(fd,MCP_RXF2SIDL,0x08,1);
	mcp25625_modifyRegister(fd,MCP_RXF3SIDL,0x08,1);
	mcp25625_modifyRegister(fd,MCP_RXF4SIDL,0x08,1);
...
/* Set TX Extended Enable bit`  */

	mcp25625_modifyRegister(fd,MCP_TXB0SIDL,0x08,0x08);
	mcp25625_modifyRegister(fd,MCP_TXB1SIDL,0x08,0x08);
	mcp25625_modifyRegister(fd,MCP_TXB2SIDL,0x08,0x08);
