...
/********************  pid[0] : LIDAR PROCESS  ************************************************/
	...
	{	
		...
		while(1)
		{
			...
			printf("LLLLLLLLLLLLLLLLLLLL VALUE =%d\n",Lidar_Value);
/*
			...
			if(*flag_PmodToLidar)
			{
				...
				*LidarValue = Lidar_Value;
				printf("LLLLLLLLLLLLLLLLLLLLLLLLL VALUE : %d\n\n\n",*LidarValue);
...
/*
		while(1)
		{
			...
			*flag_PmodToInput = 1;
			...
			if(sleepCount == 5)
			{
				printf("PPPPPPPPPPPPPPPPPPP VALUE : %d\n\n",Lidar_Value);
				sleepCount = 0;
			...
			if(*flag_LidarToPmod)
			{
				printf("PPPPPPPPPPPPPPPPPPPPPPPPPP VALUE : %d\n\n\n",*LidarValue);
