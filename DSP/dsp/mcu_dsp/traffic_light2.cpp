...
void chk_traffic_color(Mat croi, int idx)
{
	...
	switch(idx)
	{
		case 0:
			printf("r = %d, g = %d, b = %d\n",
			       croi.at<Vec3b>(15, 15)[0],
			       croi.at<Vec3b>(15, 15)[1],
			       croi.at<Vec3b>(15, 15)[2]);
		...
		case 1:
			printf("r = %d, g = %d, b = %d\n",
				croi.at<Vec3b>(76, 109)[0],
				croi.at<Vec3b>(76, 109)[1],
				croi.at<Vec3b>(76, 109)[2]);
		...
		case 2:
			printf("r = %d, g = %d, b = %d\n",
				croi.at<Vec3b>(341, 138)[0],
				croi.at<Vec3b>(341, 138)[1],
				croi.at<Vec3b>(341, 138)[2]);
